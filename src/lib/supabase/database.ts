  ...
  public: {
    Tables: {
      ...
      blouse_configurations: {
        Row: {
          blouse_measurement_template_id: string | null
          created_at: string
          customization_type:
            | Database["public"]["Enums"]["customization_type"]
            | null
          id: string
      ...
      products: {
        Row: {
          ...
          supported_customization_types: Database["public"]["Enums"]["customization_type"][]
          updated_at: string
          work_types: string[]
        }
        Insert: {
